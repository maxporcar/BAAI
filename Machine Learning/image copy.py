...
#
#
input_folder = r"H:\Mi unidad\Max Porcar (Copia de seguretat)\4 TC IUT-UQAC-IAE-THU\5ème année (Exchange)\Classes\OK-Business Analytics and AI Application\BAAI\Machine Learning\images"
...
for filename in os.listdir(input_folder):
    if filename.endswith(('.jpg', '.JPG', '.jpeg', '.png')):  # Check if the file is an image
        ...
        if classification in cat_classes:
            ...
            print(f'{filename} is not a cat, dog or fruit.')
